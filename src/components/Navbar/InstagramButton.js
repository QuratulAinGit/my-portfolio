...
import './InstagramButton.css'; // Ensure this file is in the same folder
    ...
    <button className="insta-Btn">
      ...
      >
        <path d="M224.1 141c-63.6 0-114.9 51.3-114.9 
          ...
          36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 
      ...
      <span className="insta-text">AinySoomro</span>
    </button>
  );
};
